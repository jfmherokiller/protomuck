...
extern void prim_updatemsdp_var(PRIM_PROTOTYPE);
#define PRIMS_SYSTEM_FUNCS prim_sysparm, prim_setsysparm, prim_version, \
    ...
    prim_shutdown, prim_restart, prim_armageddon, prim_sysparm_array, prim_updatemsdp_var

#define PRIMS_SYSTEM_NAMES "SYSPARM", "SETSYSPARM", "VERSION", \
   "FORCE", "FORCE_LEVEL", "LOGSTATUS", "DUMP", "DELTA",       \
   "SHUTDOWN", "RESTART", "ARMAGEDDON", "SYSPARM_ARRAY","UPDATE_MSDP_VAR"

#define PRIMS_SYSTEM_CNT 13
